...
class PagesBindingsServiceProvider extends ServiceProvider
{
    ...
    */
    public $bindings = [
        ...
        'InetStudio\Pages\Contracts\Observers\PageObserverContract' => 'InetStudio\Pages\Observers\PageObserver',
        ...
        'InetStudio\Pages\Contracts\Services\Back\PagesObserverServiceContract' => 'InetStudio\Pages\Services\Back\PagesObserverService',
